...
({
    ...
    handleRecordChange : function(component, event, helper) {
        ...
        if (changeType === "ERROR") { /* handle error; do this first! */ }
            ...
            var techScore = component.get("v.candidate.Technical_Interview_Score__c");
            console.log("handleRecordChange.techScore: " + techScore);
    
            var recScore = component.get("v.candidate.Recruiter_Interview_Score__c");
            console.log("handleRecordChange.recScore: " + recScore);
    
            var manScore = component.get("v.candidate.Management_Interview_Score__c");
